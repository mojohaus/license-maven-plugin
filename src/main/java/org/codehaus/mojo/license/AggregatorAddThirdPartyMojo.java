 ...
 */
@Mojo(
        name = "aggregate-add-third-party",
        aggregator = true,
...
public class AggregatorAddThirdPartyMojo extends AbstractAddThirdPartyMojo {
    ...
    protected void init() throws Exception {
        ...
        if (aggregateMissingLicensesFileArtifact != null
            ...
            LOG.warn("");
            LOG.warn(
                    "You should use *missingLicensesFileArtifact* parameter instead of deprecated *aggregateMissingLicensesFileArtifact*.");
            LOG.warn("");
    ...
    protected void doAction() throws Exception {
        ...
        for (MavenProject reactorProject : modules) {
            ...
            if (isVerbose()) {
                LOG.info(
                        "Found {} license(s) in module {}:{}",
                        childLicenseMap.size(),
                        mojo.project.getGroupId(),
                        mojo.project.getArtifactId());
            }
